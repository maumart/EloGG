...
public class Contrabass implements KinectInstrument {
	List<ContrabassString> _myStrings = new ArrayList<>();
	...
	public Contrabass(float _myNumbrOfStrings, float _myStringSpace, float _myNeckDistance,
			float _myFredDistance, PApplet p, Midi midi, int numberOfNeckAreas) {
		super();
	...
	private void generateStrings(float numberOfStrings) {
		...
		for (int i = 0; i < numberOfStrings; i++) {
			_myStrings.add(new ContrabassString(padding, i));
			padding += 1;
